...
<div id="redux-header">
    <?php if ( ! empty( $this->parent->args['display_name'] ) ) { ?>
        <div class="display_header">
            ...
            <?php } ?>
              <img src="<?php echo esc_attr(get_template_directory_uri()).'/includes/theme-options/assets/images/logo.png'?>" alt="soril logo"/>
            <h2 style="display:none"><?php echo wp_kses_post( $this->parent->args['display_name'] ); ?></h2>

            <?php if ( ! empty( $this->parent->args['display_version'] ) ) { ?>
                <span>Version:<?php echo wp_kses_post( $this->parent->args['display_version'] ); ?></span>
            <?php } ?>
